    ...
    return (
        ...
        <div className={cls.content}>
            ...
            <div className={cls.post__area}>
                <Post mas="Vasa" like="1" />
                <Post mas="petia" like="2" />
                <Post mas="galia" like="3" />
            </div>
        </div>
    )
}
